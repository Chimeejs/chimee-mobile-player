...
var store$1 = _global$3[SHARED$1] || (_global$3[SHARED$1] = {});
...
var document$1$1 = _global$3.document;
// typeof document.createElement is 'object' in old IE
...
var f$10 = _descriptors$3 ? Object.defineProperty : function defineProperty(O, P, Attributes) {
  _anObject$3(O);
...
var $export$3 = function (type, name, source) {
  ...
  var target = IS_GLOBAL ? _global$3 : IS_STATIC ? _global$3[name] : (_global$3[name] || {})[PROTOTYPE$5];
  var key, own, out;
  if (IS_GLOBAL) source = name;
  for (key in source) {
    // contains in native
...
var _objectSap$1 = function (KEY, exec) {
  ...
  var exp = {};
  exp[KEY] = exec(fn);
  _export$3(_export$3.S + _export$3.F * _fails$3(function () { fn(1); }), 'Object', exp);
};
...
var keys$1$1 = _core$3.Object.keys;

var keys$2 = createCommonjsModule$2(function (module) {
module.exports = { "default": keys$1$1, __esModule: true };
});

var _Object$keys$1 = unwrapExports$2(keys$2);
...
var defineProperty$8 = createCommonjsModule$2(function (module) {
module.exports = { "default": defineProperty$2$3, __esModule: true };
});

unwrapExports$2(defineProperty$8);
...
var _redefine$2 = _hide$3;

var _objectDps$1 = _descriptors$3 ? Object.defineProperties : function defineProperties(O, Properties) {
  _anObject$3(O);
  var keys = _objectKeys$1(Properties);
  var length = keys.length;
  var i = 0;
  var P;
  while (length > i) _objectDp$3.f(O, P = keys[i++], Properties[P]);
  return O;
};

var document$2$1 = _global$3.document;
...
var _objectCreate$1 = Object.create || function create(O, Properties) {
  var result;
  if (O !== null) {
    Empty$1[PROTOTYPE$1$1] = _anObject$3(O);
    result = new Empty$1();
...
// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
_hide$3(IteratorPrototype$1, _wks$1('iterator'), function () { return this; });

var _iterCreate$1 = function (Constructor, NAME, next) {
  Constructor.prototype = _objectCreate$1(IteratorPrototype$1, { next: _propertyDesc$3(1, next) });
...
var _iterDefine$1 = function (Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCED) {
  ...
  if ($anyNative) {
    ...
    if (IteratorPrototype !== Object.prototype && IteratorPrototype.next) {
      ...
      // fix for some old engines
      if (!_library$1 && !_has$2(IteratorPrototype, ITERATOR$5)) _hide$3(IteratorPrototype, ITERATOR$5, returnThis$1);
    }
  }
  // fix Array#{values, @@iterator}.name in V8 / FF
  ...
  if ((!_library$1 || FORCED) && (BUGGY$1 || VALUES_BUG || !proto[ITERATOR$5])) {
    _hide$3(proto, ITERATOR$5, $default);
  }
  // Plug for library
  if (DEFAULT) {
    methods = {
    ...
    } else _export$3(_export$3.P + _export$3.F * (BUGGY$1 || VALUES_BUG), NAME, methods);
  }
  return methods;
};
...
for (var i$1 = 0; i$1 < DOMIterables$1.length; i$1++) {
  ...
  var Collection$1 = _global$3[NAME$1];
  var proto$1 = Collection$1 && Collection$1.prototype;
  if (proto$1 && !proto$1[TO_STRING_TAG$1]) _hide$3(proto$1, TO_STRING_TAG$1, NAME$1);
...
var iterator$2$1 = _wksExt$1.f('iterator');

var iterator$3 = createCommonjsModule$2(function (module) {
module.exports = { "default": iterator$2$1, __esModule: true };
});

unwrapExports$2(iterator$3);

var _meta$1 = createCommonjsModule$2(function (module) {
...
var defineProperty$4$2 = _objectDp$3.f;
var _wksDefine$1 = function (name) {
  var $Symbol = _core$3.Symbol || (_core$3.Symbol = _library$1 ? {} : _global$3.Symbol || {});
  if (name.charAt(0) != '_' && !(name in $Symbol)) defineProperty$4$2($Symbol, name, { value: _wksExt$1.f(name) });
};
...
var _isArray$1 = Array.isArray || function isArray$$1(arg) {
...
var f$4$1 = function getOwnPropertyNames(it) {
  return windowNames$1 && toString$1$1.call(it) == '[object Window]' ? getWindowNames$1(it) : gOPN$1$1(_toIobject$1(it));
};
...
var f$6$1 = _descriptors$3 ? gOPD$1$1 : function getOwnPropertyDescriptor(O, P) {
  O = _toIobject$1(O);
  P = _toPrimitive$3(P, true);
  if (_ie8DomDefine$3) try {
    return gOPD$1$1(O, P);
  } catch (e) { /* empty */ }
  if (_has$2(O, P)) return _propertyDesc$3(!_objectPie$1.f.call(O, P), O[P]);
};
...
var dP$1$1 = _objectDp$3.f;
var gOPN$2 = _objectGopnExt$1.f;
var $Symbol$1 = _global$3.Symbol;
var $JSON$2 = _global$3.JSON;
...
var $defineProperty$1 = function defineProperty(it, key, D) {
  ...
  _anObject$3(it);
  key = _toPrimitive$3(key, true);
  _anObject$3(D);
  if (_has$2(AllSymbols$1, key)) {
    if (!D.enumerable) {
      if (!_has$2(it, HIDDEN$1)) dP$1$1(it, HIDDEN$1, _propertyDesc$3(1, {}));
      it[HIDDEN$1][key] = true;
    } else {
      if (_has$2(it, HIDDEN$1) && it[HIDDEN$1][key]) it[HIDDEN$1][key] = false;
      D = _objectCreate$1(D, { enumerable: _propertyDesc$3(0, false) });
...
var $propertyIsEnumerable$1 = function propertyIsEnumerable(key) {
  var E = isEnum$2.call(this, key = _toPrimitive$3(key, true));
...
var $getOwnPropertySymbols$1 = function getOwnPropertySymbols(it) {
  ...
  var names = gOPN$2(IS_OP ? OPSymbols$1 : _toIobject$1(it));
  var result = [];
  var i = 0;
  var key;
  while (names.length > i) {
...
if (!USE_NATIVE$2) {
  $Symbol$1 = function Symbol() {
    ...
    var $set = function (value) {
      ...
      setSymbolDesc$1(this, tag, _propertyDesc$3(1, value));
    };
    if (_descriptors$3 && setter$1) setSymbolDesc$1(ObjectProto$1$1, tag, { configurable: true, set: $set });
    return wrap$1(tag);
  };
  ...
  _objectDp$3.f = $defineProperty$1;
...
_export$3(_export$3.G + _export$3.W + _export$3.F * !USE_NATIVE$2, { Symbol: $Symbol$1 });
...
_export$3(_export$3.S + _export$3.F * !USE_NATIVE$2, 'Symbol', {
  // 19.4.2.1 Symbol.for(key)
  'for': function (key) {
...
_export$3(_export$3.S + _export$3.F * !USE_NATIVE$2, 'Object', {
  // 19.1.2.2 Object.create(O [, Properties])
  create: $create$1,
  // 19.1.2.4 Object.defineProperty(O, P, Attributes)
...
// 24.3.2 JSON.stringify(value [, replacer [, space]])
$JSON$2 && _export$3(_export$3.S + _export$3.F * (!USE_NATIVE$2 || _fails$3(function () {
  var S = $Symbol$1();
  // MS Edge converts symbol values to JSON as {}
  // WebKit converts symbol values to JSON as null
  // V8 throws on boxed symbols
...
// 19.4.3.4 Symbol.prototype[@@toPrimitive](hint)
$Symbol$1[PROTOTYPE$2$1][TO_PRIMITIVE$1] || _hide$3($Symbol$1[PROTOTYPE$2$1], TO_PRIMITIVE$1, $Symbol$1[PROTOTYPE$2$1].valueOf);
// 19.4.3.5 Symbol.prototype[@@toStringTag]
_setToStringTag$1($Symbol$1, 'Symbol');
// 20.2.1.9 Math[@@toStringTag]
_setToStringTag$1(Math, 'Math', true);
// 24.3.3 JSON[@@toStringTag]
_setToStringTag$1(_global$3.JSON, 'JSON', true);

_wksDefine$1('asyncIterator');

_wksDefine$1('observable');

var symbol$2$1 = _core$3.Symbol;

var symbol$3 = createCommonjsModule$2(function (module) {
module.exports = { "default": symbol$2$1, __esModule: true };
});

unwrapExports$2(symbol$3);

var _typeof_1$1 = createCommonjsModule$2(function (module, exports) {
exports.__esModule = true;
...
unwrapExports$2(_typeof_1$1);

var possibleConstructorReturn$1 = createCommonjsModule$2(function (module, exports) {
exports.__esModule = true;
...
var _possibleConstructorReturn$1 = unwrapExports$2(possibleConstructorReturn$1);
...
var getOwnPropertyDescriptor$4 = createCommonjsModule$2(function (module) {
module.exports = { "default": getOwnPropertyDescriptor$1$2, __esModule: true };
});

var _Object$getOwnPropertyDescriptor$1 = unwrapExports$2(getOwnPropertyDescriptor$4);

var get$1 = createCommonjsModule$2(function (module, exports) {
exports.__esModule = true;
...
var _get$1 = unwrapExports$2(get$1);
...
var check$1 = function (O, proto) {
  _anObject$3(O);
  if (!_isObject$3(proto) && proto !== null) throw TypeError(proto + ": can't set as prototype!");
};
var _setProto$1 = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = _ctx$3(Function.call, _objectGopd$1.f(Object.prototype, '__proto__').set, 2);
        set(test, []);
        buggy = !(test instanceof Array);
      } catch (e) { buggy = true; }
      return function setPrototypeOf(O, proto) {
...
_export$3(_export$3.S, 'Object', { setPrototypeOf: _setProto$1.set });

var setPrototypeOf$2$1 = _core$3.Object.setPrototypeOf;

var setPrototypeOf$3 = createCommonjsModule$2(function (module) {
module.exports = { "default": setPrototypeOf$2$1, __esModule: true };
});

unwrapExports$2(setPrototypeOf$3);

// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
_export$3(_export$3.S, 'Object', { create: _objectCreate$1 });

var $Object$2$1 = _core$3.Object;
var create$2 = function create(P, D) {
  return $Object$2$1.create(P, D);
};

var create$3 = createCommonjsModule$2(function (module) {
module.exports = { "default": create$2, __esModule: true };
});

unwrapExports$2(create$3);

var inherits$1 = createCommonjsModule$2(function (module, exports) {
exports.__esModule = true;
...
var _inherits$1 = unwrapExports$2(inherits$1);
...
var Screen = (_class$8 = function (_Base) {
  ...
  function Screen(parent, option) {
    _classCallCheck$2(this, Screen);

    var _this = _possibleConstructorReturn$1(this, (Screen.__proto__ || _Object$getPrototypeOf$1(Screen)).call(this, parent));

    _this.state = 'small';
    _this.option = deepAssign$1(defaultOption$1, isObject(option) ? option : {});
    _this.init();
    return _this;
  }

  _createClass$2(Screen, [{
    key: 'init',
    value: function init() {
  ...
  return Screen;
}(Base), _applyDecoratedDescriptor$7(_class$8.prototype, 'screenChange', [autobind], _Object$getOwnPropertyDescriptor$1(_class$8.prototype, 'screenChange'), _class$8.prototype), _class$8);
...
var ProgressBar = (_class$1$2 = function (_Base) {
  ...
  function ProgressBar(parent, option) {
    ...
    _this.option = deepAssign$1(defaultOption$2, isObject(option) ? option : {});
...
var CurrentTime = function (_Base) {
  ...
  function CurrentTime(parent, option) {
    _classCallCheck$2(this, CurrentTime);

    var _this = _possibleConstructorReturn$1(this, (CurrentTime.__proto__ || _Object$getPrototypeOf$1(CurrentTime)).call(this, parent));

    _this.option = deepAssign$1(defaultOption$3, isObject(option) ? option : {});
    _this.init();
    return _this;
  }

  _createClass$2(CurrentTime, [{
    key: 'init',
    value: function init() {
...
var TotalTime = function (_Base) {
  ...
  function TotalTime(parent, option) {
    _classCallCheck$2(this, TotalTime);

    var _this = _possibleConstructorReturn$1(this, (TotalTime.__proto__ || _Object$getPrototypeOf$1(TotalTime)).call(this, parent));

    _this.option = deepAssign$1(defaultOption$4, isObject(option) ? option : {});
    _this.init();
    return _this;
  }

  _createClass$2(TotalTime, [{
    key: 'init',
    value: function init() {
...
var mobiControlbar = gestureFactory({
  ...
  init: function init(videoConfig) {
    ...
    this.config = isObject(this.$config) ? deepAssign$1(defaultConfig$1, this.$config) : defaultConfig$1;
...
var chimeeState = gestureFactory({
  ...
  init: function init() {
    this.config = isObject(this.$config) ? deepAssign$1(defaultConfig$2, this.$config) : defaultConfig$2;
    this._addInnerHtml();
  },
  inited: function inited() {
  ...
  events: {
    ...
    panmove: function panmove(evt) {
      this.emit('state-panmove');
    },
    panend: function panend(evt) {
      this.emit('state-panend');
    },
    tap: function tap(evt) {
      this.emit('state-tap');
    },
