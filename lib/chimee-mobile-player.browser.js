 ...
 * @return {Function}    the handler
 */
function genTraversalHandler$2(fn) {
  var setter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (target, key, value) {
    target[key] = value;
  };
...
var _deepAssign$2 = genTraversalHandler$2(function (val) {
  return val;
});
/**
 * merge multiple objects
...
function deepAssign$2() {
  ...
  var target = args.shift();
  args.forEach(function (source) {
    return _deepAssign$2(source, target);
  });
  return target;
}
...
var ChimeeKernel = function (_CustEvent) {
  ...
  */
  function ChimeeKernel(videoElement, config) {
    ...
    _this.config = deepAssign$2({}, defaultConfig, config);
  ...
  _createClass(ChimeeKernel, [{
    ...
    value: function initVideoKernel() {
      ...
      deepAssign$2(config, customConfig);
    ...
    value: function bindEvents(videoKernel) {
      ...
      kernelEvents$1.forEach(function (eventName) {
        /* istanbul ignore next  */
...
var _global$5 = createCommonjsModule$2(function (module) {
// https://github.com/zloirock/core-js/issues/86#issuecomment-115759028
var global = module.exports = typeof window != 'undefined' && window.Math == Math
  ? window : typeof self != 'undefined' && self.Math == Math ? self
  // eslint-disable-next-line no-new-func
...
var _core$5 = createCommonjsModule$2(function (module) {
var core = module.exports = { version: '2.5.1' };
if (typeof __e == 'number') __e = core; // eslint-disable-line no-undef
});

var _core_1$3 = _core$5.version;
...
var document$4 = _global$5.document;
// typeof document.createElement is 'object' in old IE
var is$3 = _isObject$5(document$4) && _isObject$5(document$4.createElement);
var _domCreate$5 = function (it) {
  return is$3 ? document$4.createElement(it) : {};
};

var _ie8DomDefine$5 = !_descriptors$5 && !_fails$5(function () {
  return Object.defineProperty(_domCreate$5('div'), 'a', { get: function () { return 7; } }).a != 7;
});
...
var f$10 = _descriptors$5 ? Object.defineProperty : function defineProperty(O, P, Attributes) {
  _anObject$5(O);
...
var _hide$5 = _descriptors$5 ? function (object, key, value) {
  return _objectDp$5.f(object, key, _propertyDesc$5(1, value));
} : function (object, key, value) {
  object[key] = value;
  return object;
};
...
var $export$5 = function (type, name, source) {
  ...
  var exports = IS_GLOBAL ? _core$5 : _core$5[name] || (_core$5[name] = {});
  var expProto = exports[PROTOTYPE$5];
  var target = IS_GLOBAL ? _global$5 : IS_STATIC ? _global$5[name] : (_global$5[name] || {})[PROTOTYPE$5];
  var key, own, out;
  if (IS_GLOBAL) source = name;
  for (key in source) {
    // contains in native
    ...
    exports[key] = IS_GLOBAL && typeof target[key] != 'function' ? source[key]
    // bind timers to global for call from export context
    : IS_BIND && own ? _ctx$5(out, _global$5)
    // wrap global constructors for prevent change them in library
    : IS_WRAP && target[key] == out ? (function (C) {
      var F = function (a, b, c) {
        if (this instanceof C) {
    ...
    if (IS_PROTO) {
      (exports.virtual || (exports.virtual = {}))[key] = out;
      // export proto methods to core.%CONSTRUCTOR%.prototype.%NAME%
      if (type & $export$5.R && expProto && !expProto[key]) _hide$5(expProto, key, out);
    }
  }
};
// type bitmap
...
/**
 * chimee-plugin-mobile-controlbar v0.0.8
 * (c) 2017 yandeqiang
 * Released under ISC
 */
...
var _global$4 = createCommonjsModule$1(function (module) {
// https://github.com/zloirock/core-js/issues/86#issuecomment-115759028
var global = module.exports = typeof window != 'undefined' && window.Math == Math
  ? window : typeof self != 'undefined' && self.Math == Math ? self
  // eslint-disable-next-line no-new-func
...
var store$1 = _global$4[SHARED$1] || (_global$4[SHARED$1] = {});
...
var _uid$4 = function (key) {
  return 'Symbol('.concat(key === undefined ? '' : key, ')_', (++id$3 + px$2).toString(36));
};

var shared$2 = _shared$2('keys');

var _sharedKey$2 = function (key) {
  return shared$2[key] || (shared$2[key] = _uid$4(key));
};
...
var _objectKeysInternal$2 = function (object, names) {
  ...
  var result = [];
  var key;
  for (key in O) if (key != IE_PROTO$3) _has$4(O, key) && result.push(key);
  // Don't enum bug & hidden keys
...
var _core$4 = createCommonjsModule$1(function (module) {
var core = module.exports = { version: '2.5.1' };
if (typeof __e == 'number') __e = core; // eslint-disable-line no-undef
});

var _core_1$2 = _core$4.version;
...
var document$1$1 = _global$4.document;
// typeof document.createElement is 'object' in old IE
var is$2 = _isObject$4(document$1$1) && _isObject$4(document$1$1.createElement);
...
var f$9 = _descriptors$4 ? Object.defineProperty : function defineProperty(O, P, Attributes) {
  _anObject$4(O);
...
var _objectSap$2 = function (KEY, exec) {
  ...
  var exp = {};
  exp[KEY] = exec(fn);
  _export$4(_export$4.S + _export$4.F * _fails$4(function () { fn(1); }), 'Object', exp);
};
...
var keys$1$1 = _core$4.Object.keys;

var keys$3 = createCommonjsModule$1(function (module) {
module.exports = { "default": keys$1$1, __esModule: true };
});

var _Object$keys$1 = unwrapExports$1(keys$3);
...
var _objectGpo$2 = Object.getPrototypeOf || function (O) {
  O = _toObject$2(O);
  if (_has$4(O, IE_PROTO$1$1)) return O[IE_PROTO$1$1];
  if (typeof O.constructor == 'function' && O instanceof O.constructor) {
    return O.constructor.prototype;
...
var getPrototypeOf$1$1 = _core$4.Object.getPrototypeOf;

var getPrototypeOf$4 = createCommonjsModule$1(function (module) {
module.exports = { "default": getPrototypeOf$1$1, __esModule: true };
});

var _Object$getPrototypeOf$1 = unwrapExports$1(getPrototypeOf$4);
...
var _objectDps$2 = _descriptors$4 ? Object.defineProperties : function defineProperties(O, Properties) {
  _anObject$4(O);
  var keys = _objectKeys$2(Properties);
  var length = keys.length;
  var i = 0;
  var P;
  while (length > i) _objectDp$4.f(O, P = keys[i++], Properties[P]);
  return O;
};

var document$2$1 = _global$4.document;
...
var _objectCreate$2 = Object.create || function create(O, Properties) {
  var result;
  if (O !== null) {
    Empty$1[PROTOTYPE$1$1] = _anObject$4(O);
    result = new Empty$1();
...
var Symbol = _global$4.Symbol;
var USE_SYMBOL = typeof Symbol == 'function';

var $exports = module.exports = function (name) {
  return store[name] || (store[name] =
    USE_SYMBOL && Symbol[name] || (USE_SYMBOL ? Symbol : _uid$4)('Symbol.' + name));
};

$exports.store = store;
});

var def$1 = _objectDp$4.f;

var TAG$2 = _wks$2('toStringTag');

var _setToStringTag$2 = function (it, tag, stat) {
  if (it && !_has$4(it = stat ? it : it.prototype, TAG$2)) def$1(it, TAG$2, { configurable: true, value: tag });
};

var IteratorPrototype$1 = {};

// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
_hide$4(IteratorPrototype$1, _wks$2('iterator'), function () { return this; });

var _iterCreate$2 = function (Constructor, NAME, next) {
  Constructor.prototype = _objectCreate$2(IteratorPrototype$1, { next: _propertyDesc$4(1, next) });
...
var _iterDefine$2 = function (Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCED) {
  ...
  if ($anyNative) {
    ...
    if (IteratorPrototype !== Object.prototype && IteratorPrototype.next) {
      ...
      // fix for some old engines
      if (!_library$2 && !_has$4(IteratorPrototype, ITERATOR$5)) _hide$4(IteratorPrototype, ITERATOR$5, returnThis$1);
    }
  }
  // fix Array#{values, @@iterator}.name in V8 / FF
  ...
  if ((!_library$2 || FORCED) && (BUGGY$1 || VALUES_BUG || !proto[ITERATOR$5])) {
    _hide$4(proto, ITERATOR$5, $default);
  }
  // Plug for library
  if (DEFAULT) {
    methods = {
    ...
    if (FORCED) for (key in methods) {
      if (!(key in proto)) _redefine$4(proto, key, methods[key]);
    } else _export$4(_export$4.P + _export$4.F * (BUGGY$1 || VALUES_BUG), NAME, methods);
  }
  return methods;
};
...
for (var i$1 = 0; i$1 < DOMIterables$1.length; i$1++) {
  ...
  var Collection$1 = _global$4[NAME$1];
  var proto$1 = Collection$1 && Collection$1.prototype;
  if (proto$1 && !proto$1[TO_STRING_TAG$1]) _hide$4(proto$1, TO_STRING_TAG$1, NAME$1);
...
var defineProperty$4$2 = _objectDp$4.f;
var _wksDefine$2 = function (name) {
  var $Symbol = _core$4.Symbol || (_core$4.Symbol = _library$2 ? {} : _global$4.Symbol || {});
  if (name.charAt(0) != '_' && !(name in $Symbol)) defineProperty$4$2($Symbol, name, { value: _wksExt$2.f(name) });
};
...
var f$5$1 = Object.getOwnPropertyNames || function getOwnPropertyNames(O) {
...
var f$4$1 = function getOwnPropertyNames(it) {
...
var f$6$1 = _descriptors$4 ? gOPD$1$1 : function getOwnPropertyDescriptor(O, P) {
  O = _toIobject$2(O);
  P = _toPrimitive$4(P, true);
  if (_ie8DomDefine$4) try {
    return gOPD$1$1(O, P);
  } catch (e) { /* empty */ }
  if (_has$4(O, P)) return _propertyDesc$4(!_objectPie$2.f.call(O, P), O[P]);
};
...
var dP$1$1 = _objectDp$4.f;
var gOPN$3 = _objectGopnExt$2.f;
var $Symbol$1 = _global$4.Symbol;
var $JSON$2 = _global$4.JSON;
...
var QObject$1 = _global$4.QObject;
// Don't use setters in Qt Script, https://github.com/zloirock/core-js/issues/173
var setter$1 = !QObject$1 || !QObject$1[PROTOTYPE$2$1] || !QObject$1[PROTOTYPE$2$1].findChild;

// fallback for old Android, https://code.google.com/p/v8/issues/detail?id=687
var setSymbolDesc$1 = _descriptors$4 && _fails$4(function () {
...
var $defineProperty$1 = function defineProperty(it, key, D) {
  ...
  _anObject$4(it);
  key = _toPrimitive$4(key, true);
  _anObject$4(D);
  if (_has$4(AllSymbols$1, key)) {
    if (!D.enumerable) {
      if (!_has$4(it, HIDDEN$1)) dP$1$1(it, HIDDEN$1, _propertyDesc$4(1, {}));
      it[HIDDEN$1][key] = true;
    } else {
      if (_has$4(it, HIDDEN$1) && it[HIDDEN$1][key]) it[HIDDEN$1][key] = false;
      D = _objectCreate$2(D, { enumerable: _propertyDesc$4(0, false) });
...
var $propertyIsEnumerable$1 = function propertyIsEnumerable(key) {
  var E = isEnum$2.call(this, key = _toPrimitive$4(key, true));
  if (this === ObjectProto$1$1 && _has$4(AllSymbols$1, key) && !_has$4(OPSymbols$1, key)) return false;
  return E || !_has$4(this, key) || !_has$4(AllSymbols$1, key) || _has$4(this, HIDDEN$1) && this[HIDDEN$1][key] ? E : true;
};
var $getOwnPropertyDescriptor$2 = function getOwnPropertyDescriptor(it, key) {
  it = _toIobject$2(it);
  key = _toPrimitive$4(key, true);
  if (it === ObjectProto$1$1 && _has$4(AllSymbols$1, key) && !_has$4(OPSymbols$1, key)) return;
  var D = gOPD$3(it, key);
  if (D && _has$4(AllSymbols$1, key) && !(_has$4(it, HIDDEN$1) && it[HIDDEN$1][key])) D.enumerable = true;
  return D;
};
var $getOwnPropertyNames$1 = function getOwnPropertyNames(it) {
  ...
  var key;
  while (names.length > i) {
    if (!_has$4(AllSymbols$1, key = names[i++]) && key != HIDDEN$1 && key != META$1) result.push(key);
  } return result;
};
var $getOwnPropertySymbols$1 = function getOwnPropertySymbols(it) {
  ...
  var key;
  while (names.length > i) {
    if (_has$4(AllSymbols$1, key = names[i++]) && (IS_OP ? _has$4(ObjectProto$1$1, key) : true)) result.push(AllSymbols$1[key]);
  } return result;
};
...
if (!USE_NATIVE$2) {
  $Symbol$1 = function Symbol() {
    ...
    var tag = _uid$4(arguments.length > 0 ? arguments[0] : undefined);
    var $set = function (value) {
      if (this === ObjectProto$1$1) $set.call(OPSymbols$1, value);
      if (_has$4(this, HIDDEN$1) && _has$4(this[HIDDEN$1], tag)) this[HIDDEN$1][tag] = false;
      setSymbolDesc$1(this, tag, _propertyDesc$4(1, value));
    };
    if (_descriptors$4 && setter$1) setSymbolDesc$1(ObjectProto$1$1, tag, { configurable: true, set: $set });
    return wrap$1(tag);
  };
  _redefine$4($Symbol$1[PROTOTYPE$2$1], 'toString', function toString() {
    return this._k;
  });

  _objectGopd$2.f = $getOwnPropertyDescriptor$2;
  _objectDp$4.f = $defineProperty$1;
  ...
  if (_descriptors$4 && !_library$2) {
    _redefine$4(ObjectProto$1$1, 'propertyIsEnumerable', $propertyIsEnumerable$1, true);
  }
...
_export$4(_export$4.G + _export$4.W + _export$4.F * !USE_NATIVE$2, { Symbol: $Symbol$1 });
...
_export$4(_export$4.S + _export$4.F * !USE_NATIVE$2, 'Symbol', {
  // 19.4.2.1 Symbol.for(key)
  'for': function (key) {
    return _has$4(SymbolRegistry$1, key += '')
...
_export$4(_export$4.S + _export$4.F * !USE_NATIVE$2, 'Object', {
  // 19.1.2.2 Object.create(O [, Properties])
  create: $create$1,
  // 19.1.2.4 Object.defineProperty(O, P, Attributes)
...
// 24.3.2 JSON.stringify(value [, replacer [, space]])
$JSON$2 && _export$4(_export$4.S + _export$4.F * (!USE_NATIVE$2 || _fails$4(function () {
  var S = $Symbol$1();
  // MS Edge converts symbol values to JSON as {}
  // WebKit converts symbol values to JSON as null
  // V8 throws on boxed symbols
...
// 19.4.3.4 Symbol.prototype[@@toPrimitive](hint)
$Symbol$1[PROTOTYPE$2$1][TO_PRIMITIVE$1] || _hide$4($Symbol$1[PROTOTYPE$2$1], TO_PRIMITIVE$1, $Symbol$1[PROTOTYPE$2$1].valueOf);
// 19.4.3.5 Symbol.prototype[@@toStringTag]
_setToStringTag$2($Symbol$1, 'Symbol');
// 20.2.1.9 Math[@@toStringTag]
_setToStringTag$2(Math, 'Math', true);
// 24.3.3 JSON[@@toStringTag]
_setToStringTag$2(_global$4.JSON, 'JSON', true);

_wksDefine$2('asyncIterator');

_wksDefine$2('observable');

var symbol$2$1 = _core$4.Symbol;

var symbol$4 = createCommonjsModule$1(function (module) {
module.exports = { "default": symbol$2$1, __esModule: true };
});

unwrapExports$1(symbol$4);
...
var _possibleConstructorReturn$1 = unwrapExports$1(possibleConstructorReturn$1);
...
var getOwnPropertyDescriptor$4 = createCommonjsModule$1(function (module) {
module.exports = { "default": getOwnPropertyDescriptor$1$2, __esModule: true };
});

var _Object$getOwnPropertyDescriptor$1 = unwrapExports$1(getOwnPropertyDescriptor$4);

var get$2 = createCommonjsModule$1(function (module, exports) {
exports.__esModule = true;
...
var _get$1 = unwrapExports$1(get$2);
...
var check$1 = function (O, proto) {
  _anObject$4(O);
  if (!_isObject$4(proto) && proto !== null) throw TypeError(proto + ": can't set as prototype!");
};
var _setProto$2 = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = _ctx$4(Function.call, _objectGopd$2.f(Object.prototype, '__proto__').set, 2);
        set(test, []);
        buggy = !(test instanceof Array);
      } catch (e) { buggy = true; }
      return function setPrototypeOf(O, proto) {
...
_export$4(_export$4.S, 'Object', { setPrototypeOf: _setProto$2.set });

var setPrototypeOf$2$1 = _core$4.Object.setPrototypeOf;

var setPrototypeOf$4 = createCommonjsModule$1(function (module) {
module.exports = { "default": setPrototypeOf$2$1, __esModule: true };
});

unwrapExports$1(setPrototypeOf$4);

// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
_export$4(_export$4.S, 'Object', { create: _objectCreate$2 });

var $Object$2$1 = _core$4.Object;
var create$2$1 = function create(P, D) {
  return $Object$2$1.create(P, D);
};

var create$4 = createCommonjsModule$1(function (module) {
module.exports = { "default": create$2$1, __esModule: true };
});

unwrapExports$1(create$4);
...
var _inherits$1 = unwrapExports$1(inherits$1);
  ...
  _createClass$1(Base, [{
    ...
    value: function addAllEvent() {
      ...
      this.option.event && _Object$keys$1(this.option.event).forEach(function (item) {
        var key = '__' + item;
        _this[key] = bind$1(_this.option.event[item], _this);
        addDelegate$1(_this.parent, _this.option.tag, item, _this[key], false, false);
      });
    }
  }, {
    ...
    value: function removeAllEvent() {
      ...
      this.option.defaultEvent && _Object$keys$1(this.option.defaultEvent).forEach(function (item) {
        ...
        _this2[key] = bind$1(_this2[key], _this2);
        removeDelegate$1(_this2.parent, _this2.option.tag, item, _this2[key], false, false);
      });
      this.option.event && _Object$keys$1(this.option.event).forEach(function (item) {
        var key = '__' + item;
        _this2[key] = bind$1(_this2.option.event[item], _this2);
        removeDelegate$1(_this2.parent, _this2.option.tag, item, _this2[key], false, false);
      });
    }
  }]);
...
var mobiControlbar = gestureFactory({
  ...
  init: function init(videoConfig) {
    ...
    this.config = isObject$1(this.$config) ? deepAssign$1(defaultConfig$1, this.$config) : defaultConfig$1;
...
var _global$6 = createCommonjsModule$3(function (module) {
// https://github.com/zloirock/core-js/issues/86#issuecomment-115759028
var global = module.exports = typeof window != 'undefined' && window.Math == Math
  ? window : typeof self != 'undefined' && self.Math == Math ? self
  // eslint-disable-next-line no-new-func
...
var _core$6 = createCommonjsModule$3(function (module) {
var core = module.exports = { version: '2.5.1' };
if (typeof __e == 'number') __e = core; // eslint-disable-line no-undef
});

var _core_1$4 = _core$6.version;
...
var document$5 = _global$6.document;
// typeof document.createElement is 'object' in old IE
var is$4 = _isObject$6(document$5) && _isObject$6(document$5.createElement);
var _domCreate$6 = function (it) {
  return is$4 ? document$5.createElement(it) : {};
};

var _ie8DomDefine$6 = !_descriptors$6 && !_fails$6(function () {
  return Object.defineProperty(_domCreate$6('div'), 'a', { get: function () { return 7; } }).a != 7;
});
...
var f$11 = _descriptors$6 ? Object.defineProperty : function defineProperty(O, P, Attributes) {
  _anObject$6(O);
...
var _hide$6 = _descriptors$6 ? function (object, key, value) {
  return _objectDp$6.f(object, key, _propertyDesc$6(1, value));
} : function (object, key, value) {
  object[key] = value;
  return object;
};
...
var $export$6 = function (type, name, source) {
  ...
  var exports = IS_GLOBAL ? _core$6 : _core$6[name] || (_core$6[name] = {});
  var expProto = exports[PROTOTYPE$6];
  ...
  for (key in source) {
    ...
    exports[key] = IS_GLOBAL && typeof target[key] != 'function' ? source[key]
    // bind timers to global for call from export context
    : IS_BIND && own ? _ctx$6(out, _global$6)
    // wrap global constructors for prevent change them in library
    : IS_WRAP && target[key] == out ? (function (C) {
      var F = function (a, b, c) {
        if (this instanceof C) {
    ...
    if (IS_PROTO) {
      (exports.virtual || (exports.virtual = {}))[key] = out;
      // export proto methods to core.%CONSTRUCTOR%.prototype.%NAME%
      if (type & $export$6.R && expProto && !expProto[key]) _hide$6(expProto, key, out);
    }
  }
};
// type bitmap
...
var supportGesture$1 = ['tap', 'swipe', 'panstart', 'panmove', 'panend', 'press', 'doubletap'];
function gestureFactory$2() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref$name = _ref.name,
      name = _ref$name === undefined ? 'chimeeGesture' : _ref$name,
      el = _ref.el,
  ...
  return {
    ...
    beforeCreate: function beforeCreate(config) {
      ...
      supportGesture$1.forEach(function (item) {
        _this.gesture.on(item, function (evt) {
          var func = config.events[item];
          func && func.call(_this, evt);
        });
...
/**
 * chimee-plugin-mobile-state v0.0.7
 * (c) 2017 yandeqiang
 * Released under ISC
 */
...
var chimeeState = gestureFactory$2({
  name: 'chimeeState',
...
var classCallCheck$4 = createCommonjsModule$4(function (module, exports) {
exports.__esModule = true;
...
var _classCallCheck$4 = unwrapExports$4(classCallCheck$4);

var _global$7 = createCommonjsModule$4(function (module) {
// https://github.com/zloirock/core-js/issues/86#issuecomment-115759028
var global = module.exports = typeof window != 'undefined' && window.Math == Math
  ? window : typeof self != 'undefined' && self.Math == Math ? self
  // eslint-disable-next-line no-new-func
...
var _core$7 = createCommonjsModule$4(function (module) {
var core = module.exports = { version: '2.5.1' };
if (typeof __e == 'number') __e = core; // eslint-disable-line no-undef
});

var _core_1$5 = _core$7.version;

var _aFunction$7 = function (it) {
  if (typeof it != 'function') throw TypeError(it + ' is not a function!');
  return it;
};
...
var _ctx$7 = function (fn, that, length) {
  _aFunction$7(fn);
  if (that === undefined) return fn;
  switch (length) {
    case 1: return function (a) {
...
var _isObject$7 = function (it) {
  return typeof it === 'object' ? it !== null : typeof it === 'function';
};

var _anObject$7 = function (it) {
  if (!_isObject$7(it)) throw TypeError(it + ' is not an object!');
  return it;
};

var _fails$7 = function (exec) {
  try {
    return !!exec();
  } catch (e) {
    return true;
...
// Thank's IE8 for his funny defineProperty
var _descriptors$7 = !_fails$7(function () {
  return Object.defineProperty({}, 'a', { get: function () { return 7; } }).a != 7;
});

var document$6 = _global$7.document;
// typeof document.createElement is 'object' in old IE
var is$5 = _isObject$7(document$6) && _isObject$7(document$6.createElement);
var _domCreate$7 = function (it) {
  return is$5 ? document$6.createElement(it) : {};
};

var _ie8DomDefine$7 = !_descriptors$7 && !_fails$7(function () {
  return Object.defineProperty(_domCreate$7('div'), 'a', { get: function () { return 7; } }).a != 7;
});
...
// instead of the ES6 spec version, we didn't implement @@toPrimitive case
// and the second argument - flag - preferred type is a string
var _toPrimitive$7 = function (it, S) {
  if (!_isObject$7(it)) return it;
  var fn, val;
  if (S && typeof (fn = it.toString) == 'function' && !_isObject$7(val = fn.call(it))) return val;
  if (typeof (fn = it.valueOf) == 'function' && !_isObject$7(val = fn.call(it))) return val;
  if (!S && typeof (fn = it.toString) == 'function' && !_isObject$7(val = fn.call(it))) return val;
  throw TypeError("Can't convert object to primitive value");
};
...
var f$12 = _descriptors$7 ? Object.defineProperty : function defineProperty(O, P, Attributes) {
  _anObject$7(O);
  P = _toPrimitive$7(P, true);
  _anObject$7(Attributes);
  if (_ie8DomDefine$7) try {
...
var _propertyDesc$7 = function (bitmap, value) {
  return {
    enumerable: !(bitmap & 1),
    configurable: !(bitmap & 2),
    writable: !(bitmap & 4),
...
var _hide$7 = _descriptors$7 ? function (object, key, value) {
  return _objectDp$7.f(object, key, _propertyDesc$7(1, value));
} : function (object, key, value) {
  object[key] = value;
  return object;
};
...
var $export$7 = function (type, name, source) {
  ...
  var exports = IS_GLOBAL ? _core$7 : _core$7[name] || (_core$7[name] = {});
  var expProto = exports[PROTOTYPE$7];
  var target = IS_GLOBAL ? _global$7 : IS_STATIC ? _global$7[name] : (_global$7[name] || {})[PROTOTYPE$7];
  var key, own, out;
  if (IS_GLOBAL) source = name;
  for (key in source) {
    // contains in native
    ...
    exports[key] = IS_GLOBAL && typeof target[key] != 'function' ? source[key]
    // bind timers to global for call from export context
    : IS_BIND && own ? _ctx$7(out, _global$7)
    // wrap global constructors for prevent change them in library
    : IS_WRAP && target[key] == out ? (function (C) {
      var F = function (a, b, c) {
        if (this instanceof C) {
      ...
      return F;
    // make static versions for prototype methods
    })(out) : IS_PROTO && typeof out == 'function' ? _ctx$7(Function.call, out) : out;
    // export proto methods to core.%CONSTRUCTOR%.methods.%NAME%
    if (IS_PROTO) {
      (exports.virtual || (exports.virtual = {}))[key] = out;
      // export proto methods to core.%CONSTRUCTOR%.prototype.%NAME%
      if (type & $export$7.R && expProto && !expProto[key]) _hide$7(expProto, key, out);
    }
  }
};
// type bitmap
...
var _export$7 = $export$7;

// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
_export$7(_export$7.S + _export$7.F * !_descriptors$7, 'Object', { defineProperty: _objectDp$7.f });

var $Object$7 = _core$7.Object;
var defineProperty$2$5 = function defineProperty(it, key, desc) {
  return $Object$7.defineProperty(it, key, desc);
};

var defineProperty$9 = createCommonjsModule$4(function (module) {
module.exports = { "default": defineProperty$2$5, __esModule: true };
});

unwrapExports$4(defineProperty$9);

var createClass$4 = createCommonjsModule$4(function (module, exports) {
exports.__esModule = true;



var _defineProperty2 = _interopRequireDefault(defineProperty$9);
...
var _createClass$4 = unwrapExports$4(createClass$4);
...
var Gesture$2 = function () {
  function Gesture() {
    _classCallCheck$4(this, Gesture);
  ...
  _createClass$4(Gesture, [{
    ...
    key: 'fire',
    value: function fire(type, evt) {
      if (!isArray$4(this.event[type])) return;
      this.event[type].forEach(function (item) {
        item(evt);
      });
    }
...
ChimeeMobilePlayer.gestureFactory = gestureFactory$4;
