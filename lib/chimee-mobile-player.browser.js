...
/**
 * chimee-plugin-mobile-controlbar v0.0.5
 * (c) 2017 yandeqiang
 * Released under ISC
 */
...
function __$styleInject$1(css, returnValue) {
  if (typeof document$3$1 === 'undefined') {
    return returnValue;
  }
  css = css || '';
  var head = document$3$1.head || document$3$1.getElementsByTagName('head')[0];
  var style = document$3$1.createElement('style');
  style.type = 'text/css';
  head.appendChild(style);
...
function gestureFactory$1() {
  ...
  return {
    ...
    beforeCreate: function beforeCreate(config) {
      ...
      var gesture = this.gesture = new Gesture$1();
...
ChimeeMobilePlayer.gestureFactory = gestureFactory$2;
